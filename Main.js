...
Elm.Models.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var Sponsor = F3(function (a,b,c) {    return {name: a,url: b,image: c};});
   var Event = F7(function (a,b,c,d,e,f,g) {    return {title: a,date: b,presenter: c,description: d,logo: e,venue: f,link: g};});
   var Venue = F2(function (a,b) {    return {name: a,address: b};});
   var Model = F3(function (a,b,c) {    return {next: a,pastEvents: b,sponsors: c};});
   return _elm.Models.values = {_op: _op,Model: Model,Venue: Venue,Event: Event,Sponsor: Sponsor};
};
Elm.Views = Elm.Views || {};
Elm.Views.make = function (_elm) {
   "use strict";
   _elm.Views = _elm.Views || {};
   if (_elm.Views.values) return _elm.Views.values;
   var _U = Elm.Native.Utils.make(_elm),
   ...
   var socialIcons = function () {
      var gitHub = "https://github.com/WpgDotNetUG/UserGroupWebsite";
      var youTube = "https://www.youtube.com/channel/UC6OzdI6-htXE_97zamJRaaA";
      var facebook = "https://www.facebook.com/winnipegdotnet";
      var twitter = "https://twitter.com/wpgnetug";
      var icon = function (id) {
         return A2($Html.span,
         _U.list([$Html$Attributes.$class("fa-stack fa-2x")]),
         _U.list([A2($Html.i,_U.list([$Html$Attributes.$class("fa fa-circle fa-stack-2x")]),_U.list([]))
                 ,A2($Html.i,_U.list([$Html$Attributes.$class(A2($Basics._op["++"],"fa fa-stack-1x fa-",id))]),_U.list([]))]));
      };
      var linkTo = F4(function (link,i,t,hint) {
         return A2($Html.a,
         _U.list([$Html$Attributes.title(hint),$Html$Attributes.$class("sm-link"),$Html$Attributes.href(link),$Html$Attributes.target("_blank")]),
         _U.list([icon(i),$Html.text(t)]));
      });
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("social-icons")]),
      _U.list([A4(linkTo,twitter,"twitter","Follow","Follow us on Twitter")
              ,A4(linkTo,facebook,"facebook","Like","Like us on Facebook")
              ,A4(linkTo,youTube,"youtube-play","Subscribe","Subscribe to our YouTube channel to get notifications")
              ,A4(linkTo,gitHub,"github","Fork","Fork us on GitHub and collaborate")]));
   }();
   var iconFor = function (icn) {    return A2($Html.i,_U.list([$Html$Attributes.$class(A2($Basics._op["++"],"fa fa-",icn))]),_U.list([]));};
   var slackForm = A2($Html.div,
   _U.list([$Html$Attributes.$class("slack-form")]),
   _U.list([A2($Html.form,
   _U.list([$Html$Attributes.$class("form-inline"),$Html$Attributes.title("Chat with us on Slack")]),
   _U.list([A2($Html.div,
   _U.list([$Html$Attributes.$class("form-group")]),
   _U.list([A2($Html.label,_U.list([]),_U.list([iconFor("slack"),$Html.text("slack")]))
           ,A2($Html.div,
           _U.list([$Html$Attributes.$class("input-group")]),
           _U.list([A2($Html.input,
                   _U.list([$Html$Attributes.title("Enter your email and submit to get an invite")
                           ,$Html$Attributes.$class("form-control")
                           ,$Html$Attributes.type$("text")
                           ,$Html$Attributes.placeholder("you@domain.com")]),
                   _U.list([]))
                   ,A2($Html.div,_U.list([$Html$Attributes.$class("input-group-addon")]),_U.list([iconFor("chevron-right")]))]))]))]))]));
   var socialMedia = A2($Html.div,_U.list([$Html$Attributes.$class("social-media")]),_U.list([slackForm,socialIcons]));
   var logoMenu = A2($Html.div,
   _U.list([$Html$Attributes.$class("logo-menu")]),
   _U.list([A2($Html.img,_U.list([$Html$Attributes.src("/assets/images/logo.png")]),_U.list([]))
           ,A2($Html.section,
           _U.list([$Html$Attributes.$class("motto")]),
           _U.list([A2($Html.header,_U.list([]),_U.list([$Html.text("Winnipeg Dot Net User Group")]))
                   ,A2($Html.div,
                   _U.list([$Html$Attributes.$class("description")]),
                   _U.list([$Html.text("A user group full of lambdas, folds, MVC, ponnies and rainbows!")]))]))
           ,A2($Html.div,
           _U.list([$Html$Attributes.$class("main-menu")]),
           _U.list([A2($Html.a,
                   _U.list([$Html$Attributes.title("Open Event Brite page")
                           ,$Html$Attributes.href("http://www.eventbrite.com/org/1699161450")
                           ,$Html$Attributes.target("_blank")]),
                   _U.list([$Html.text("Events")]))
                   ,A2($Html.a,_U.list([$Html$Attributes.title("Watch past presentations"),$Html$Attributes.href("#watch-us")]),_U.list([$Html.text("Videos")]))
                   ,A2($Html.a,_U.list([$Html$Attributes.title("Contact us"),$Html$Attributes.href("#contact-us")]),_U.list([$Html.text("Contact")]))]))]));
   var nextEvent = function () {
      var workingOnIt = A2($Html.section,
      _U.list([$Html$Attributes.$class("next-event")]),
      _U.list([A2($Html.header,_U.list([]),_U.list([$Html.text("We are working on it")])),A2($Html.article,_U.list([]),_U.list([$Html.text("Like crazy")]))]));
      var showEvent = function (e) {
         return A2($Html.section,
         _U.list([$Html$Attributes.$class("next-event")]),
         _U.list([A2($Html.header,_U.list([$Html$Attributes.$class("event-header")]),_U.list([$Html.text("Next Event")]))
                 ,A2($Html.article,
                 _U.list([]),
                 _U.list([A2($Html.div,
                         _U.list([$Html$Attributes.$class("event-img")]),
                         _U.list([A2($Html.img,_U.list([$Html$Attributes.src(e.logo)]),_U.list([]))]))
                         ,A2($Html.div,
                         _U.list([$Html$Attributes.$class("event-info")]),
                         _U.list([A2($Html.div,_U.list([$Html$Attributes.$class("title")]),_U.list([$Html.text(e.title)]))
                                 ,A2($Html.label,_U.list([]),_U.list([$Html.text("Description")]))
                                 ,A2($Html.div,_U.list([$Html$Attributes.$class("description")]),_U.list([$Html.text(e.description)]))
                                 ,A2($Html.div,
                                 _U.list([$Html$Attributes.$class("date")]),
                                 _U.list([A2($Html.div,_U.list([$Html$Attributes.$class("icon")]),_U.list([iconFor("calendar")]))
                                         ,$Html.text(A2($Date$Format.format,"%A, %B %e, %Y",e.date))]))
                                 ,A2($Html.div,
                                 _U.list([$Html$Attributes.$class("venue")]),
                                 _U.list([A2($Html.div,_U.list([$Html$Attributes.$class("icon")]),_U.list([iconFor("map-marker")]))
                                         ,A2($Html.span,_U.list([$Html$Attributes.$class("name")]),_U.list([$Html.text(e.venue.name)]))
                                         ,A2($Html.span,_U.list([$Html$Attributes.$class("address")]),_U.list([$Html.text(e.venue.address)]))]))
                                 ,A2($Html.footer,
                                 _U.list([]),
                                 _U.list([A2($Html.a,_U.list([$Html$Attributes.href(e.link)]),_U.list([$Html.text("Count me in!")]))]))]))]))]));
      };
      return function (_p0) {
         return A2($Maybe.withDefault,workingOnIt,A2($Maybe.map,showEvent,_p0));
      };
   }();
   var pastEvents = function (events) {
      var mkWidget = function (e) {
         return A2($Html.div,
         _U.list([$Html$Attributes.$class("past-event")]),
         _U.list([A2($Html.div,_U.list([$Html$Attributes.$class("image")]),_U.list([A2($Html.img,_U.list([$Html$Attributes.src(e.logo)]),_U.list([]))]))
                 ,A2($Html.div,
                 _U.list([$Html$Attributes.$class("info")]),
                 _U.list([A2($Html.div,_U.list([$Html$Attributes.$class("title")]),_U.list([$Html.text(e.title)]))
                         ,A2($Html.div,_U.list([$Html$Attributes.$class("date")]),_U.list([$Html.text(A2($Date$Format.format,"%b %e, %Y",e.date))]))
                         ,A2($Html.div,
                         _U.list([$Html$Attributes.$class("view")]),
                         _U.list([A2($Html.a,_U.list([$Html$Attributes.href(e.link),$Html$Attributes.target("_blank")]),_U.list([$Html.text("View")]))]))]))]));
      };
      return A2($Html.section,
      _U.list([$Html$Attributes.$class("past-events")]),
      _U.list([A2($Html.header,_U.list([$Html$Attributes.$class("event-header")]),_U.list([$Html.text("Past Events")]))
              ,A2($Html.article,_U.list([]),A2($List.map,mkWidget,A2($List.take,3,events)))
              ,A2($Html.footer,
              _U.list([]),
              _U.list([A2($Html.a,
              _U.list([$Html$Attributes.href("http://www.eventbrite.ca/o/winnipeg-dot-net-user-group-1699161450"),$Html$Attributes.target("_blank")]),
              _U.list([$Html.text("View All")]))]))]));
   };
   var view = F2(function (address,model) {
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("container")]),
      _U.list([A2($Html.header,_U.list([]),_U.list([socialMedia,logoMenu]))
              ,nextEvent(model.next)
              ,pastEvents(model.pastEvents)
              ,A2($Html.div,_U.list([$Html$Attributes.$class("subscribe-list")]),_U.list([$Html.text("subscribe & twitter stream")]))
              ,A2($Html.section,_U.list([$Html$Attributes.$class("sponsors")]),_U.list([$Html.text("sponsors go heere")]))
              ,A2($Html.section,_U.list([$Html$Attributes.$class("contact-us")]),_U.list([$Html.text("Amir, David & Roy")]))
              ,A2($Html.footer,_U.list([]),_U.list([$Html.text("here goes the footer")]))]));
   });
   return _elm.Views.values = {_op: _op
                              ,view: view
...
Elm.Main.make = function (_elm) {
   ...
   var init = function () {
      var nextMonth = A2($Result.withDefault,$Date.fromTime(0),$Date.fromString("2011/1/1"));
      var library = {address: "211 Donald St.",name: "Millenium library"};
      ...
      var event = {title: "Cool APIs with Suave.io"
                  ...
                  ,date: nextMonth};
      var empty = {title: "",description: "",venue: library,presenter: event.presenter,link: event.link,logo: event.logo,date: $Date.fromTime(0)};
      var model = {next: $Maybe.Just(event)
                  ,pastEvents: _U.list([_U.update(empty,{title: "Stealing Time with the .Net ThreadPool"})
                                       ,_U.update(empty,{title: "VS Code-- The Visual Studio For Everyone"})
                                       ,_U.update(empty,{title: "Not just for games: Creating slick UIs with Unity, C# and XAML"})
                                       ,_U.update(empty,{title: "What to Expect with MVC 6"})])
                  ,sponsors: _U.list([])};
      return {ctor: "_Tuple2",_0: model,_1: $Effects.none};
   }();
   var app = $StartApp.start({init: init,view: $Views.view,update: update,inputs: _U.list([])});
   var main = app.html;
   var tasks = Elm.Native.Task.make(_elm).performSignal("tasks",app.tasks);
   return _elm.Main.values = {_op: _op,app: app,main: main,init: init,update: update};
};
